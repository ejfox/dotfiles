// Vulpes TFT - subtle LCD subpixel effect
// More subtle than default for daily driving

/** Size of TFT "pixels" - larger = more subtle */
float resolution = 3.0;

/** Strength of effect - lower = more subtle */
float strength = 0.25;
