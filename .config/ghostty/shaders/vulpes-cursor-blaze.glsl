// Vulpes Cursor Blaze - cursor trail in vulpes red/pink
// Based on: https://gist.github.com/chardskarth/95874c54e29da6b5a36ab7b50ae2d088
// Modified for vulpes aesthetic
...
// ═══════════════════════════════════════════════════════════════════════════
// VULPES COLORS - hot pink / deep red aesthetic
// ═══════════════════════════════════════════════════════════════════════════
const vec4 TRAIL_COLOR = vec4(1.0, 0.2, 0.45, 1.0);        // Hot pink #ff3373
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0.8, 0.0, 0.25, 1.0); // Deep red #cc0040

const float DURATION = .4;           // Slightly faster fade
const float OPACITY = .25;           // Slightly more visible
